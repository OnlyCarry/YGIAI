...
class field;
struct loc_info;
extern bool customAIEnabled;
int getAIAction(field* game_field);
void executeAIAction(int action);
GameState extractGameState(field* game_field);
bool isAIPlayer(int32_t player);
